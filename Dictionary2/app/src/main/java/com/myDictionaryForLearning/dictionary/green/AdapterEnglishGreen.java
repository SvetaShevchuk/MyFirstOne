...
public class AdapterEnglishGreen extends RecyclerView.Adapter<AdapterEnglishGreen.ViewHolderEnglish> {
    private Context context;

    public AdapterEnglishGreen(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public AdapterEnglishGreen.ViewHolderEnglish onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_english_grey, parent, false);
        return new AdapterEnglishGreen.ViewHolderEnglish(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterEnglishGreen.ViewHolderEnglish holder,
                                 @SuppressLint("RecyclerView") int position) {
        holder.tv_english.setText(AdapterGreen.myArray.get(position).getEnglish());
        holder.button_translate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                holder.tv_english_gone.setText(AdapterGreen.myArray.get(position).getRussian());
