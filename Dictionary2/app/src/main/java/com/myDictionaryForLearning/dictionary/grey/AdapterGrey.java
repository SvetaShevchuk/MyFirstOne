...
public class AdapterGrey extends RecyclerView.Adapter<AdapterGrey.ViewHolderDict> {
    ...
    public AdapterGrey(Context context) {
    ...
    @NonNull
    @Override
    public  AdapterGrey.ViewHolderDict onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_view_grey, parent,
                false);
        return new  AdapterGrey.ViewHolderDict(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterGrey.ViewHolderDict holder,
