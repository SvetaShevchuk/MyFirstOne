...
import com.noteinapocket.noteinapocket.NoteActivityBlue;
import com.noteinapocket.noteinapocket.R;

import java.util.ArrayList;

public class AdapterNoteBlue extends RecyclerView.Adapter<AdapterNoteBlue.NoteViewHolder> {
    Context context;
    public static ArrayList<ListItem> noteArray;

    public AdapterNoteBlue(Context context) {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.tv_note.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, NoteActivityBlue.class);
