...
import com.noteinapocket.noteinapocket.NoteActivityYellow;
import com.noteinapocket.noteinapocket.R;

import java.util.ArrayList;

public class AdapterNoteYellow extends RecyclerView.Adapter<AdapterNoteYellow.NoteViewHolder> {
    Context context;
    public static ArrayList<ListItem> noteArray;

    public AdapterNoteYellow(Context context) {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.tv_note.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, NoteActivityYellow.class);
