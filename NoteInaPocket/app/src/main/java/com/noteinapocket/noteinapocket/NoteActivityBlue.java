...
public class NoteActivityBlue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_blue);
        init();
        dbManager.openDb();
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(tv_text_note.getText().toString().equals("")){
                    Toast.makeText(NoteActivityBlue.this, no_save, Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void init(){
        tv_text_note = findViewById(R.id.tv_text_note_blue);
        button_back = findViewById(R.id.button_save_note_blue);
