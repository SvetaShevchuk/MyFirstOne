...
import com.noteinapocket.noteinapocket.db.AdapterNoteBlue;
...
public class MainActivityBlue extends AppCompatActivity {
    ...
    private AdapterNoteBlue adapter;
    DbManager dbManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityBlue.this, EditActivityBlue.class);
    ...
    void init(){
        image_create = findViewById(R.id.image_create_blue);
        tv_create = findViewById(R.id.tv_create_blue);
        recyclerView = findViewById(R.id.recycler_view_blue);
        dbManager = new DbManager(this);
        adapter = new AdapterNoteBlue(this);
