...
import com.noteinapocket.noteinapocket.NoteActivityRed;
import com.noteinapocket.noteinapocket.R;

import java.util.ArrayList;

public class AdapterNoteRed extends RecyclerView.Adapter<AdapterNoteRed.NoteViewHolder> {
    Context context;
    public static ArrayList<ListItem> noteArray;

    public AdapterNoteRed(Context context) {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.tv_note.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, NoteActivityRed.class);
